    ...
    <section id="properties" className="bg-brand-charcoal py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 items-center">
          {/* Left: heading */}
          <div>
            <p className="font-display font-black uppercase text-brand-lime leading-tight"
              style={{ fontSize: "clamp(1rem, 2vw, 1.2rem)" }}>
              Serving a Wide Range of
            </p>
            <h2 className="font-display font-black uppercase text-white leading-tight mt-1"
